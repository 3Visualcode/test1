...
if ( ! tutor_utils()->is_instructor( get_current_user_id(), true ) || ! tutor_utils()->can_user_edit_course( get_current_user_id(), $course_id ) ) {
	//echo "is_instructor---".json_encode(tutor_utils()->is_instructor( get_current_user_id(), true ))."<br>";
	//echo "can_user_edit_course---".json_encode(tutor_utils()->can_user_edit_course( get_current_user_id(), $course_id ))."<br>";
	//die("ciao12334");
	tutor_permission_denied_template( $course_id );
}
?>
